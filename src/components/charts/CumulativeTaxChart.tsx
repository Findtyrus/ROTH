    ...
    <div style={{ width: '100%', height: 280 }}>
      <ResponsiveContainer>
        <AreaChart data={data} margin={{ top: 10, right: 20, left: 10, bottom: 0 }}>
          ...
          <Area type="monotone" dataKey="traditional" name="Traditional IRA" stroke="var(--blue-light)" fill="url(#tGrad)" strokeWidth={2} />
          <Area type="monotone" dataKey="rothIRA" name="Roth (Tax from IRA)" stroke="var(--orange-light)" fill="url(#bGrad)" strokeWidth={2} />
          <Area type="monotone" dataKey="rothCash" name="Roth (Tax from Cash)" stroke="var(--green-light)" fill="url(#cGrad)" strokeWidth={2} />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  )
